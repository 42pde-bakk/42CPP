...
void Contact::set_postal_address(std::string address) {
  _postal_address = address;
}
void Contact::set_email_address(std::string address) {
...
void Contact::set_underwear_colour(std::string colour) {
  _underwear_colour = colour;
}
